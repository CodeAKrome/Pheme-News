...
if len(sys.argv) != 2:
    print("Usage: python tohtml8.py <input_jsonl_file>")
    sys.exit(1)
...
entity_to_articles = defaultdict(list)  # Fixed: Changed DEFAULTDICT to defaultdict
type_to_entities = defaultdict(set)    # Fixed: Changed DEFAULTDICT to defaultdict
