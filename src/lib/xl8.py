...
class Xl8:
    ...
    def translate_article(self, article, source_lang, target_lang='en', max_tokens=None):
        """
...
if __name__ == "__main__":
    ...
    for lang, article in articles.items():
        ...
        translated, input_tokens, output_tokens = translator.translate_article(article, lang, max_tokens=1200)
    ...
    french_translation, input_tokens, output_tokens = translator.translate(english_article, 'en', 'fr', max_tokens=300)
